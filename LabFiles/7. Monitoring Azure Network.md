...
4. On the **Basics** tab of **Create a flow log**, enter the following details:
      ...
      - Retention(days) : Select **7 (1)**

      - Select **Configuration (2)**

        ![flow log](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/createf.png?raw=true)
...
1. Repeat step-3 and step-4 to create NSG flow logs for the **<inject key="VM2" enableCopy="false"/>**.
