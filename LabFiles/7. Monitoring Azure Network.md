...
1. In the container, navigate the folder hierarchy until you get to a PT1H.json file and seleect it. Log files are written to a folder hierarchy that follows the following          naming convention: 
...
12. Under **Notification** page, follow below steps:
    ...
    - Enter your **Odl Email address (2)**
...
17. You have successfully created the Alert Rule. To view the Alert Rule, click on **Total alert rules**. It might take a few minutes for changes to be shown.

    ![TAR](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/alerts1.png?raw=true)
       
18. To test the notifications for the Alert Rule, browse the firewall's public IP Address in the new tab and refresh the page for every 2 minutes.
