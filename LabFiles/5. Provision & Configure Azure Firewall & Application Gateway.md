...
6. Under **Add a backend pool** page, enter the below steps:
      ...
      - Taget:Select **<inject key="VM1Name" enableCopy="false"/>-nic** from down-down list.

      - Target type: Again select **Virtual Machine** from drop-down

      - Taget:Select **<inject key="VM2Name" enableCopy="false"/>-nic** from down-down list.
...
14. Select **<inject key="AppgatewayName" enableCopy="true"/>** from the overview page of resource group.
...
2.  Click on the firewall **<inject key="Firewall" enableCopy="true"/>**.
