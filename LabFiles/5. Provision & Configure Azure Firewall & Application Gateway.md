...
7. Select **Firewall public IP** from the Overview page of **AzFW-<inject key="DeploymentID" enableCopy="false"/>**.
 ...
 8. Copt the **Public Ip Address** of the firewall and note it down the text editor. You will be using it in the next tasks.
...
1. Attackers can attack your application by passing this **?q=<script>** value at the end of the web application URL or IP address.
    
2. Now pass the value **?q=<script>** at the end of your **Application gateway** and try browsing it. You can still see the webpage.
    
    ![ss](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/web.png?raw=true)
    
3. To prevent the application from attackers, Select **Appgateway-<inject key="DeploymentID" enableCopy="true"/>** from the overview page of the resource group.
