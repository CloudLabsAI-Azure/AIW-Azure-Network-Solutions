...
Azure Route Tables, or User Defined Routing, allow you to create network routes so that your CloudGen Firewall VM can handle the traffic both between your subnets and to the Internet. ... When different route types are present in a UDR route table, user defined routes are preferred over the default system routes. 
  
1. On the Azure Portal **Home** page, search for **Route Tables** and select it.
  
   ![rp](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/route.png?raw=true)
