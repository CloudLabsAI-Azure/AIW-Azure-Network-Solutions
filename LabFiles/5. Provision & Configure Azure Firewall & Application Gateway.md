...
1. On the Azure Portal **Home** page, search for **Route Tables** and select it.                                                                             .      
   ...
   <kbd>![rp](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/route.png?raw=true)</kbd>
      
1. On the **Route Tables** page, select **+ Create**.                                                                                                       .
  
   <kbd>![create](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/RTC.png?raw=true)</kbd>
...
1. Under the **Basics** tab of **Create route table**, follow the below details:    
    ...
    - Select **Review + Create**                                                                                                                     .
     ...
     <kbd>![create](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/rbas.png?raw=true)</kbd>
    
1. Review the configuration and select **Create**.                                                                                               .
  
   <kbd>![create](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/qq1.png?raw=true)</kbd>
...
1. Under **Add Route** page, enter the below information:    
    ...
    - Select **Ok**   
     ...
     <kbd>![ok](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/routeadd.png?raw=true)</kbd>
...
1. Now select **Subnets(1)** and Click on **Associate(2)**.    
   - Under Associate subnets, enter the following details:
    ...
    <kbd>![ok](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/subnets.png?raw=true)</kbd>
