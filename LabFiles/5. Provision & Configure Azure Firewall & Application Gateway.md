...
The Web Portal is gaining traction and Contoso is required to meet the certain Security & Compliance guidelines (Something which is accommodated by Azure Firewall/AP with WAF) before they can make it available to wider audience. You are tasked to redesign and publish the application securely. 
...
1. Connect the remote desktop to firewall public IP address.
...
1. Now, navigate back to the remote desktop and refresh the tab, you will be able to access the page.
  
     <kbd>![blocked](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/page.png?raw=true)</kbd>
