...
Azure Application Gateway is a web traffic load balancer that enables you to manage traffic to your web applications. In this task, you'll create an Application Gateway with WAF. Azure Web Application Firewall (WAF) on Azure Application Gateway provides centralized protection of your web applications from common exploits and vulnerabilities.

If you want to explore more about Application gateway, explore https://docs.microsoft.com/en-us/azure/application-gateway/overview
