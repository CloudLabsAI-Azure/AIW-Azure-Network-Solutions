...
### Overview
  ...
  In this exercise, you will deploy a Firewall and Application Gateway with WAF and publish an application. You'll also test the application for security and perform a sample attack, and also you'll configure UDR and outbound traffic to go via  Azure Firewall
