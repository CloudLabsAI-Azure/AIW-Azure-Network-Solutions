...
5. Repeat the step-2 for creating **Internal** subnet

    - **Name** : **Internal**
    - **Subnet Address Range** : **10.0.3.0/24** (Make sure that Subnet Address Range is within the range of default Address Space of VNet)
    - Select **Save**
