...
You will help Contoso to meet the Security & Compliance guidelines by creating an Azure firewall, Application Gateway (WAF) so that the Firewall will be internert facing resource and all traffic will be passed to the application gateway via azure firewall. 
