...
1. On the Azure Portal **Home** page, type **Azure Firewall (1)** and select **Firewalls (2)**.
    ...
    ![firewall](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Services/raw/main/media/Azurefirewallnew.png?raw=true)
    
1. Click on **Create firewall** under **Firewalls** page.

    ![create firewall](https://github.com/Divyasri199/AIW-Azure-Network-Services/blob/main/media/createfirewall.png?raw=true)
...
1. Under **Backends** tab, select **Add a backend pool**
    ...
    ![bp](https://github.com/Divyasri199/AIW-Azure-Network-Services/blob/main/media/bp.png?raw=true)
...
1. Select **Review + create**, from Create application gateway.
     ...
     ![create](https://github.com/Divyasri199/AIW-Azure-Network-Services/blob/main/media/rc2.png?raw=true)
...
1. Now pass the value **?q=<script>** at the end of your **Firewall** IP and try browsing it. You can observe the Server Error.
   ...
   ![ss](https://github.com/Divyasri199/AIW-Azure-Network-Services/blob/main/media/server.png?raw=true)
...
1. Now, navigate back to the tab where you browsed the IP Address and refresh the page. You can observe the Server Error.
    ...
    ![server error](https://github.com/Divyasri199/AIW-Azure-Network-Services/blob/main/media/server.png?raw=true)
...
1. On the **Route Tables** page, select **+ Create**. 
    ...
    ![](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Services/blob/main/media/RTC.png?raw=true)
