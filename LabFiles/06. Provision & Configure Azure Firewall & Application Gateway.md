...
1. Now, navigate back to the remote desktop and refresh the tab, you will be able to access the Bing page. Now open a new tab in the browser and search for **what is my ip**. You will be able to view the IP Address of the Azure Firewall. This will confirm that the outbound traffic is going via Firewall.
