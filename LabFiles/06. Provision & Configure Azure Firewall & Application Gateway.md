...
1. Under **Backends** page, select **Add a backend pool**
...
1. Navigate to the overview page of the resource group and ensure that you will be able to see the deployed Application gateway **<inject key="AppgatewayName" enableCopy="false"/>**.
...
1. Now, to test the application copy and paste the Public IP address of **Firewall** from the virtual machine's Overview page into a new tab and browse it.
...
1. To make your application more secure, select **Appgateway-<inject key="DeploymentID" enableCopy="false"/>** from the overview page of the resource group.
...
In the previous task, you have enhanced the security of your application with WAP policy. In this task you will configure user defined route and outbound traffic to go via Azure firewall.
