...
# Exercise 3: Provision Contoso Application in Existing Network
...
* [Exercise 1: Deploy VM using pre-built ARM Template in existing network](#task-1-deploy-vm-using-pre-built-arm-template-in-the-existing-network)

* [Exercise 2: Add Public IP to the virtual machine](#task-2-add-public-ip-to-the-virtual-machine)

* [Exercise 3: Configure NSGs and allow Application Access](#task-3-configure-nsgsasgs-and-allow-application-access)

* [Exercise 4: Test Application](#task-4-test-application) 
