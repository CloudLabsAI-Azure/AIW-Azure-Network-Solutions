...
5. Once the deployment is complete, naviate back to the Azure **Home** page and in the search box type network, and then select Network Security Group.
...
7. Select **Network interfaces** under **Settings** from Network Security Group balde and check if the **NSG** is associated with the **NIC**. If you don't see any associations follow the below steps:
