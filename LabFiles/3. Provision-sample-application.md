...
4. E On the Custom deployment basics tab enter the following values to deploy the template.
...
5. Once the deployment is complete, navigate back to the resource group **hands-on-lab-<inject key="DeploymentID" enableCopy="false"/>** and select the virtual machine VM2- from the Overview tab.
