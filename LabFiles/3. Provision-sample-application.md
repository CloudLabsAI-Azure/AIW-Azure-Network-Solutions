...
*	Deploy VM using pre-built ARM Template in existing network [https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/LabFiles/3.%20Provision-sample-application.md#task-1-deploy-vm-using-pre-built-arm-template-in-existing-network]
