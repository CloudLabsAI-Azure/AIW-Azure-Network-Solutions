...
6. Provide the following information under **Add inbound security rule**:
     ...
     - **Destination Port Range**: Enter **3389 (1)**
...
7. You'll be directed to the webpage with the name as **<inject key="VM2Name" enableCopy="false"/>** shown in the screenshot below.
