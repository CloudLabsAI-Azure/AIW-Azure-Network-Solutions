...
In this exercise, you will create a primary and secondary virtual machine along with load balancer to check the Load Balancing & VM failover.
...
1. Search for **templates(1)** in the azure portal's search box, then pick **Template deployment (deploy using custom templates)(2)** under market place.

    ![template](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/templates.png?raw=true)
...
7. After the template has been successfully created, click **Go to Resource**.
    ...
    ![go to resource](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/template1.png?raw=true)
...
1. Navigate to the resource group **hands-on-lab-<inject key="DeploymentID" enableCopy="false"/>** and select the virtual machine **VM1-<inject key="DeploymentID" enableCopy="false"/>** from **Overview** tab
   ...
   ![vm1.1](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/vmq.png?raw=true)
   
2. You can observe that the virtual machine doesn't have a public IP address from the **Overview** tab.

   ![noIP](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/noipvm1.png?raw=true)

   
3. Navigate back to the **Azure Portal** by selecting the **Home** from top left corner then search for **Public IP Address** and select it.

     ![Create resource](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/publicip.png?raw=true)
     
     
4. Now click on **Create**

    ![create Vnet](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/pip2.1.png?raw=true)
    
5. Provide the following information to create Public IP Address:
...
7. To associate the Public IP address with the VM, click on **Associate** and follow the procedures mentioned below inside the  **Associate Public IP address** tab.
...
9. You can observe the corresponding **Public IP address** on the virtual machine's **Overview** tab.
...
1. From your **Azure Portal**, search for **Network Security Group** and click on it.

   ![NSG](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/networksecurity.png?raw=true)
   
2. Click on **Create**

    ![nsg create](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/nsgcreate.png?raw=true)
...
4. Follow the below instructions to associate NSG to the deployed VM
     ...
     - Under the **Network interface associations** select **nic** of **VM1-<inject key="DeploymentID" enableCopy="false"/>**
...
9. Provide the following information to create Public IP Address:
   ...
   - Name : **PublicIP2-<inject key="DeploymentID" enableCopy="false"/>**
