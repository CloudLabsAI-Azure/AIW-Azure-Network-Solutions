...
In this task, you will deploy a virtual machine without public IP address using ARM template.
...
In this task, you will associate create and associate Public IP Address to Virtual Machine that you created earlier in the previous task.
...
In this task, you will create a Network Security Group and connect it to the Virtual Machine's Network Interface to allow internet access to the application hosted on it.
...
In this task you will browse to the Virtual Machines public ip and verify the accessibility of the web application.
...
3. Browse to the Public IP and verify deployment of the web application is working.
...
1. Navigate back to Azure portal home page, from the search bar search for **Load balancers** and select it.
...
3. On **Create load balancer** page under the **basic** tab enter the following deatils:
