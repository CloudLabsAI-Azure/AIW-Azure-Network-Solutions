...
9. Click on the **Green** icon which indicates the Azure region and select **More details** 

      ![md](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/md.png?raw=true)
      
10.  Under **More Insights**, you can see traffic distribution for East US deployments.
