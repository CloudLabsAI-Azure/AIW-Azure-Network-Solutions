...
3. From the options on the left side of the **Subscriptions** blade, select **Resource providers**, under **Settings**.
...
5. Now from **Home** page of Azure Portal, search for **Storage account** from the search box and then click on it. The primary purpose of creating a storage account is to store NSG flow logs.
...
7.  On the **Basics** tab of **Storage account** blade, enter the below details:
 ...
 9. From **Home** page of Azure Portal, search for **Log Analytics Workspace** from the search box and then click on it. The main purpose of using Log Analytics Workspace is, to collect and store log data. 

      ![LAW](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/LAW.png?raw=true)
      
 10. From the **Log Analytics Workspaces** page, select **Create Log Analytics Workspace**.
 ...
 12. Review the configuration of create analytics workspace and select **Create**
...
17. Review the configuration of create a flow log and select **Create**
...
In this task, you will be enabling the Traffic Analytics in the NSG flow logs to review the logs.
 ...
 1.  Now select the created NSG flow log.

       ![nsg](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/nsflowlog.png?raw=true)
       
 2. Under **Flow log settings** page, follow the below steps:

       - Check the box next to **Enable traffic Analytics**

       - Traffic Analytics processing interval : Select **Every 10 min** from drop down list.

       - Subscription : Select your **Subscription**.

       - Log Analytics Workspace : Select **LogAnalyticsWorkspace** from drop down list.
