...
1. Select **Network Performance Monitor(1)** under **Monitoring** from **Network Watcher** page and click on **Add(2)**

     ![npm](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/NPMA.png?raw=true)
2. 

1. Search for the **Solutions** from Azure Portal's **Home** page and select it.

     ![solutions](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/solution.png?raw=true)
     
2. Click on **Create** from the **Solutions** page

     ![screate](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/screate.png?raw=true)
     
3. Under the solutions' **Marketplace**, search for **Log Analytics workspce** and select it.

     ![MP](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/MP.png?raw=true)
     
4. Now, under Log Analytics Workspace select **Create(1)** and click on **Log Analytics Workspace(2)**.

     ![LAwork](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/LAwork.png?raw=true)
     
5. Under **Enable Non-Azure** page, enter the following details:
...
6. Monitor the deployment status by selecting **Notifications** Bell icon at the top of the portal. In a minute or so, you should see a confirmation of the successful deployment.
