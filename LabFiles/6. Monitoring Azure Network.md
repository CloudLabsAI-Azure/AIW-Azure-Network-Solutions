...
6. Under the **Flow log settings** page, follow the below steps:
...
7. Select **Traffic Analytics**, under **Logs** from the options on the left side of the Network Watcher blade.

      ![netwat](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/traffic.png?raw=true)
      
8. On the **Traffic Analytics** page, set the time interval to **Last 1 hour**.

      ![time interval](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/timeinterval.png?raw=true)
      
9. Now, you can observe the total number ofnetwork traffic flows from **Traffic Visualization**
...
10. Under **Traffic Analytics** Scroll down to **Your Environment** to view total number of **Deployed Azure Regions(1)**, **Virtual networks(2)**, **Enabled NSGs(3)**, **Virtual Subnets(4)**.

      ![env](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/env.png?raw=true)
      
11. To visualize the traffic distribution by geography, click on **View Map**. The geo-map shows the traffic distribution to a data center from countries/regions and continents communicating to it.

     ![map](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/map.png?raw=true)
     
12. In the **Traffic Analytics Geo Map View** page, click on the **Green** icon which indicates the Azure region and observe the resources deployed under the region, to explore more select **More details** 

      ![md](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/md.png?raw=true)
      
13.  Under **More Insights** blade, scroll down and explore about traffic distribution for deployments of the East US region.

     ![comm](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/comm.png?raw=true)
     
14. To close the **Traffic Analytics Geo Map View**, click on the cross at top right corner.

      ![close](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/close.png?raw=true)
      
15. Now, from **Your Environment** page, selct **Ports receiving traffic from internet**.

      ![ports](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/TTI.png?raw=true)
      
16. From **Ports receiving traffic from Internet** page, you can explore more about the ports associated to the resources.

      ![ports](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/prt.png?raw=true)
      
17. Under the Traffic Analytics page, scroll down to **Traffic Distribution** to view analytics of traffic flows across host, subnet, VNet and VMSS.

     ![tr](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/trdi.png?raw=true)
     
18. To view analytics of traffic flows across host, select **IP(1)**, then select **See all(2)** from **Traffic Distribution**.

    ![td](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/td.png?raw=true)
    
19. Observe the time trending chart for top 5 talking IPs accross **Traffic distribution across top IPs**

    ![see more](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/time.png?raw=true)
    
20. Under **Details of top 5 talking IPs**, select VM IP to explore more about traffic distribution.

     ![see more](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/ip.png?raw=true)
     
21. Close the **Traffic distribution across top IPs** by clicking the **cross(X)** at the top-left corner of the page.
    
22. In the same way, you can explore more about **Subnets**, **VNet**, **VMSS**.

23. Now scroll down to **Application ports**, to view analytics for application ports utilized across your environment and select **See all**.

     ![ap](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/ap1.png?raw=true)
     
24. From the **Most frequent L7 protocols** page, you can explore more about the ports and it's ranges.
