...
1. Navigate to the resource group **hands-on-lab-<inject key="DeploymentID" enableCopy="false"/>**, from **Overview(1)** tab select the **ANS-LB<inject key="DeploymentID" enableCopy="false"/>**.

     ![loadbalancer](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/lb1.png?raw=true)
     
2. Now select the **Overview(1)** tab from load balancer page and select the **Public IP Address** an
