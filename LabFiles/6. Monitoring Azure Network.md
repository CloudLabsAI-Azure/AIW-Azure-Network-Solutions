...
## Task 3: Setup Azure Monitor Alerts and test notifications 
...
21. Now copy the Public IP address of the **Application Gateway** from the text editor and browse the public ip in a new tab or different browser. You can see the web page as mentioned in the below screenshot

      ![ss](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/ipvm.png?raw=true)
      
22. Now copy the Public IP address of the **Firewall** from the text editor and browse the public ip in a new tab or different browser. You can see the web page as mentioned in the below screenshot

       ![ss](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/firewallip.png?raw=true)
       
23. This will confirm that you have published the application via Azure Firewall & Application Gateway.
