...
In this task, you will be creating Azure Monitor Alerts and tests the notification.
...
17. You have successfully created Alert Rule. To view the Alert Rule, click on **Total alert rules**. 
