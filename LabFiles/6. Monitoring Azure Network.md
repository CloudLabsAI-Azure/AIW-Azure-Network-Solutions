...
### Task 2.2: Create Strorage Account
...
7.  On the **Basics** tab of **Storage account** blade, enter the below details:
 ...
 In this task, you will create Log Analytics Workspace. Generally, the Log Analytics workspace is used by Traffic Analytics to store the aggregated and indexed data that is then used to generate the analytics.
