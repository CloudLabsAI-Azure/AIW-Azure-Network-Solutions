...
* [Task 4: Perform a Sample Network Troubleshooting exercise](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/LabFiles/6.%20Monitoring%20Azure%20Network.md#task-4-perform-a-sample-network-troubleshooting-exercise)
     ...
     * [Task 4.1: Ip Flow Verify](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/LabFiles/6.%20Monitoring%20Azure%20Network.md#task-41-ip-flow-verify)

     * [Task 4.2: Connection Troubleshoot](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/LabFiles/6.%20Monitoring%20Azure%20Network.md#task-42-connection-troubleshoot)
...
7.  On the **Basics** tab of **Storage account** blade, enter the below details:
       ...
       - Storage account name : **<inject key="Storageaccount Name" enableCopy="true"/>**
...
1. Navigate to the resource group **<inject key="Resource Group" enableCopy="true"/>**, from **Overview(1)** tab select the **<inject key="nsg" enableCopy="true"/>(2)**.
...
4. On the **Basics** tab of **Create a flow log**, enter the following information:
      ...
      - Storage accounts: Select **<inject key="Storageaccount Name" enableCopy="true"/>** from drop down list.
...
1. Navigate to the resource group **<inject key="Resource Group" enableCopy="true"/>**, from **Overview(1)** tab select the **<inject key="Loadbalancer" enableCopy="true"/>(2)**.
...
In this task, you will use IP Flow verify from the Network diagnostic tools to perform sample network troubleshooting.

1. Navigate to the resource group **<inject key="Resource Group" enableCopy="true"/>**, from **Overview(1)** tab select the **<inject key="VM1Name" enableCopy="false"/>(2)**.
...
6. On the **Basics** tab of **create a virtual machine** page, enter then following details:
     ...
     - Resource group: Select **<inject key="Resource Group" enableCopy="true"/>** from drop-down list.
...
12. Under the  **IP flow verify**, follow the below instructions:
      ...
      - Remote IP:Enter the **Private IP Address** of **VM2-<inject key="DeploymentID" enableCopy="false"/>** (Example: **10.0.4.4**)
...
13. Now, navigate back to the **Resource Group** and select **VM3-<inject key="DeploymentID" enableCopy="false"/>** from the **Overview** page.
...
16. After successfully creating the **Inbound rule**, move to the **Ip flow verify** under **Network watcher blade** and provide the below information:
  
       - Subscription: Select your **Subscription**

      - Resource group: 	Select **<inject key="Resource Group" enableCopy="true"/>**

      - Virtual machine: **VM3-<inject key="DeploymentID" enableCopy="false"/>**
      ...
      - Remote IP:	Enter the **Private IP Address** of **VM1-<inject key="DeploymentID" enableCopy="false"/>** (**10.0.4.4**)
...
2. Under the **Connection troubleshoot** page, enter the following details:
      ...
      - Virtual machine: Enter **VM2-<inject key="DeploymentID" enableCopy="true"/>**
...
5. Now try to establish the connection between **VM1-<inject key="DeploymentID" enableCopy="true"/>** and **<inject key="VM3Name" enableCopy="true"/>** and check for the status.
     
    ![vm3](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/check.png?raw=true)
          
      
6. You can see the status as **Unreachable**. The reason for getting the status as **Unreachable** is that you have the security group rule that blocks inbound traffic to **<inject key="VM3Name" enableCopy="true"/>** on port 80.

     ![check](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/check1.png?raw=true)

7. If you want to establish the connection between **VM1-<inject key="DeploymentID" enableCopy="true"/>** and **<inject key="VM3Name" enableCopy="true"/>**, navigate back to **<inject key="VM3Name" enableCopy="true"/>** and enable the **Port_80** under **Inbound port rules** from **Networking** tab, then perform **Connection Troubleshoot**.
...
18. To test the notifications for the Alert Rule, navigate back to the resource group **<inject key="Resource Group" enableCopy="true"/>**, and select **VM2-<inject key="DeploymentID" enableCopy="false"/>**.
