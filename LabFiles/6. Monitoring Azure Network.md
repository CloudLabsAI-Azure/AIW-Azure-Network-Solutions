...
5. Now try to establish the connection between **<inject key="VM1Name" enableCopy="true"/>** and **<inject key="VM3Name" enableCopy="true"/>** and check for the status.
...
7. If you want to establish the connection between **<inject key="VM1Name" enableCopy="true"/>** and **<inject key="VM3Name" enableCopy="true"/>**, navigate back to **<inject key="VM3Name" enableCopy="true"/>** and enable the **Port_80** under **Inbound port rules** from **Networking** tab, then perform **Connection Troubleshoot**.
...
18. To test the notifications for the Alert Rule, navigate back to the resource group **<inject key="Resource Group" enableCopy="true"/>**, and select **<inject key="VM2Name" enableCopy="false"/>**.
