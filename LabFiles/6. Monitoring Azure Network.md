...
16. On the **Basics** tab of **Create Log Analytics workspace**, enter the below information
       ...
       ![create](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/LAW1.1.png?raw=true)
       
17. Review the configuration and select **Create**

       ![createLAW](https://github.com/Divyasri199/AIW-Azure-Network-Solutions/blob/prod/media/createLAW1.2.png?raw=true)
