...
In this exercise, you enabled a Network Watcher and created Flow Logs to run Sample traffic and performed Sample network troubleshooting. You have also deployed Log Analytics Workspace and Network Monitoring Solution to setup Azure Monitor Alerts and tested the notifications.
