...
1. After adding the frontend IP Address, observe that the fronted IP configuration is listed and click on **Next: Backend Pool**.
...
1. Enter the below details to create **Backend Pool**.
 ...
 1. Now to add the virtual machines in the backend pool, select both the VMs and click on **Add**.
...
1. On the **Backed pools** tab, observe the newly added backend pool configurations listed and click on **Next: Inbound rules**.
