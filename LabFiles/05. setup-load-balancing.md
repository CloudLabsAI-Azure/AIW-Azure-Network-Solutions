...
You will help Contoso to build high available solution by creating an Azure Load balancer that distributes the load across servers evenly and will also be able to handle system failures.
