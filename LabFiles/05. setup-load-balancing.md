...
You will help Contoso to build highly available solution by creating an Azure Load balancer that distributes the load across servers evenly and will also be able to handle the load in case of system failures.
