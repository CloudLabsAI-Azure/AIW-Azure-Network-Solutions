...
1. On the Virtual machine **Overview** page observe that the virtual machine doesn't have a **Public IP address** associated. 
...
1. Now to associate the Public IP address with the VM, click on **Associate (1)** and in the **Associate public IP address** tab enter the below details:
...
1. Return to the resource group and select the **<inject key="VM1Name" enableCopy="false"/>** from the **Overview** tab.
...
1. Click on **Create network security group**.
...
1. You'll be directed to the webpage shown in the screenshot below.
