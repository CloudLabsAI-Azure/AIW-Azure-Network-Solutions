...
1. On the Virtual machine **Overview** tab observe that the virtual machine doesn't have a **Public IP address** associated. In the next steps, you will create a Public IP address and associated it to the Virtual Machines Network Interface.
...
1. Now to associate Network security group to the VM follow the below instructions:
     ...
     - Under the **Network interface associations** select **nic-contoso-frontend-prod-001**
