...
1. On the Virtual machine **Overview** tab observe that the virtual machine doesn't have a **Public IP address** associated. In the next steps you will create a Public IP address and associated it to Virtual Machines Network Interface.
...
In this task, you will create a Network Security Group, and add a inbound rule to allow inbound traffic for application access via Port 80(HTTP).
