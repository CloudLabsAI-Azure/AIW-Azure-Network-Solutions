...
1. While you wait for the resources to deploy, take some time to review the template contents. Navigate to **Templates** and observe the resources which are deploying.
    ...
    ![template](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/template.png?raw=true)
      ...
      Note that the template contains three resources. Using custom script extension, you are deploying the web application.
...
7. Now to associate the Public IP address with the VM, click on **Associate** and in the **Associate public IP address** tab enter the below details:
...
In this task, you will create a Network Security Group, add a rule to allow inbound traffic for application access
