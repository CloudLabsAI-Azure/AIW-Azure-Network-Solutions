...
5. Now try to establish the connection between **<inject key="VM1Name" enableCopy="false"/>** and **<inject key="samplevm" enableCopy="false"/>** follow the below details:
...
5. Now expand the resource group **<inject key="Resource Group" enableCopy="false"/> (1)** and select **<inject key="VM1Name" enableCopy="false"/>(2)**, then click on **Done (3)**.
...
7. Search for **Network (1)** and select **Network In total (2)**.
...
16. Under **Alert rule details**, enter the below details:
       ...
       - Select **Create alert rule (6)**
          ...
          ![create](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/aall.png?raw=true)
