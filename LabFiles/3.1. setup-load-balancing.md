...
* [Task 1: Provision Secondary VM](#task-51-provision-secondary-vm)
       
* [Task 2: Provision Load Balancing using External Load Balancer](#task-52-provision-load-balancing-using-external-load-balancer)
       
* [Task 3: Test LB & VM failover](#task-53--test-lb--vm-failover)
...
## Task 2: Provision Load Balancing using External Load Balancer 
