...
5. Navigate back to the browser where you accessed the public IP address and refresh the page, now observe the request only served by the currently running virtual machine**<inject key="VM2Name" enableCopy="false"/>**.
