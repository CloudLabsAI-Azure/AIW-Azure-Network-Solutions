...
In this exercise, You will help Contoso to setup Network landing zone 
...
4. On the **Basics** tab of **Create virtual network**, enter the following information and select **Next: IP Addresses**.
    ...
    ![vnet](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/qwer.png?raw=true)
