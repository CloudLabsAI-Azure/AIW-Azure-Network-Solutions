...
1.  In the search box, search for **Virtual Network** and click on it to select.
...
1. On the **Basics** tab of **Create virtual network**, enter the following information:
    ...
    ![vnet](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/newvnet.png?raw=true)
      ...
      > Note : You can delete the default subnet if unable to create the subnet with range 10.1.0.0/24.
...
1.  On the **IP Addresses** tab enter the below details:
     ...
     - IPv4 address space : **10.1.0.0/16 (1)**
...
1. Provide the following instructions under **Add Subnet** to create **AVD** subnet.
...
1. Repeat **step-1** for creating the **DMZ** subnet and provide the below-mentioned instructions.
...
1. Repeat **step-1** for creating **AzureFirewallSubnet** subnet and provide the below-mentioned instructions. You will use this subnet in the further exercises.
