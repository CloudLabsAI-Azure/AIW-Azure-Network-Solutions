...
In this task, you will be creating Sample VM in the virtual network which was created in Region-2.
...
In this task, you will be configure peering between the virtual network
