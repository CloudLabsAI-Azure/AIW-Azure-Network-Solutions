...
In this task, you will test the inter vm connectivity by connecting to the virtual machine in primary network then initiating connection to the vm in secondary network using private ip address.
