# Exercise 5:  Provision Secondary Azure Region Infrastructure 
 
 Duration: 20-30 mins
 
 ## Scenario
 
 Contoso Application is gaining world wide popularity, Contoso wants to have a supporting virtual machine for aplication development team. Contoso wants to have a secondary region setup in case of Azure primary region failure and also wants the vm in primary and secondary region communicate over private network.
