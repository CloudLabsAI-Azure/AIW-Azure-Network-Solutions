...
*  [Task-4 : Validate Inter VM Connectivity on private network](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/LabFiles/4.%20Provision-secondary-azure-region-infrastructure.md#task-3--configure-vnet-peering)
*  
