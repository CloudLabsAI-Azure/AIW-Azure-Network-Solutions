...
1. In the VM, search for "Default Apps". 
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/defaultapps.png?raw=true)
   
1. Scroll down to the web browser option at the bottom and select "Microsoft Edge".

   ![](https://github.com/CloudLabsAI-Azure/AIW-Azure-Network-Solutions/blob/main/media/msedge.png?raw=true)
