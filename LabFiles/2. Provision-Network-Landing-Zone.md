...
In this exercise, you'll create a Virtual Network and create subnets for different scenarios like AVD, DMZ and Internal. 
...
In this task, you will create a Subnet for different scenarios like AVD, DMZ, Internal. A subnet is a range of IP addresses in the virtual network. You can divide a virtual network into multiple subnets for organization and security.
