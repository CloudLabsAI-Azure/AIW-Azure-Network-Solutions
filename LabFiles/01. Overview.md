...
Below is the diagram of the end stage solution architecture you will build in this lab. You will build it in phases as the development and testing goes. Please study this carefully, so you understand the whole of the solution as you are working on the various components.
