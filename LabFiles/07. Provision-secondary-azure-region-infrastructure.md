...
1. Now, from your Azure Portal navigate to the resource group **rg-contoso-prod-eastus** and select private IP Address of **vm-contoso-app-prod-westus-002** from the overview page
